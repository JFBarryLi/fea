...
class InputStructureSerializer(serializers.ModelSerializer):
	class Meta:
		...
		fields = ('outer_diameter', 'inner_diameter', 'modulus_elasticity', 'yield_strength', 'connectivity_table', 'nodal_coordinates', 'boundary_conditions', 'force_vector', 'frame_or_truss')
