...
class InputStructureSerializer(serializers.ModelSerializer):
	class Meta:
		...
		fields = ('ip_address', 'outer_diameter', 'inner_diameter', 'modulus_elasticity', 'yield_strength', 'connectivity_table', 'nodal_coordinates', 'boundary_conditions', 'frame_or_truss')
